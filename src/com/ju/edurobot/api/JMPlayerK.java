 ...
 * @author Adrian BER
 */
public class JMPlayerK {

    private static Logger logger = Logger.getLogger(JMPlayerK.class.getName());
    ...
    public void open(String file) throws IOException {
        ...
        if (mplayerProcess == null) {
        	...
        	String command = "sudo SDL_VIDEODRIVER=fbcon SDL_FBDEV=/dev/fb1 mplayer "+ file;
